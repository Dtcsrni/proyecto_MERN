...
Módulo interno del portal alumno cloud (read-model, sesión y observabilidad).

Ruta: `apps/portal_alumno_cloud/src/infraestructura/observabilidad`.

## Archivos clave
- `metrics.ts`
- `middlewareObservabilidad.ts`
