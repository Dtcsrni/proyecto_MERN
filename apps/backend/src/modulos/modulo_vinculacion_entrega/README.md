# modulo vinculacion entrega

Módulo de dominio del backend docente (rutas, controlador, servicios, modelos y validaciones).

Ruta: `apps/backend/src/modulos/modulo_vinculacion_entrega`.

## Archivos clave
- `controladorVinculacionEntrega.ts`
- `modeloEntrega.ts`
- `rutasVinculacionEntrega.ts`
- `validacionesVinculacion.ts`
