...
Ruta: `apps/backend/src/modulos/modulo_calificacion`.

## Archivos clave
- `controladorCalificacion.ts`
- `modeloCalificacion.ts`
- `rutasCalificaciones.ts`
- `servicioCalificacion.ts`
- `validacionesCalificacion.ts`
