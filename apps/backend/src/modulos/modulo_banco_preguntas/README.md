# modulo banco preguntas

Módulo de dominio del backend docente (rutas, controlador, servicios, modelos y validaciones).

Ruta: `apps/backend/src/modulos/modulo_banco_preguntas`.

## Archivos clave
- `controladorBancoPreguntas.ts`
- `modeloBancoPregunta.ts`
- `modeloTemaBanco.ts`
- `rutasBancoPreguntas.ts`
- `validacionesBancoPreguntas.ts`
