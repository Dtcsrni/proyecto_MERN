...
Ruta: `apps/backend/src/modulos/modulo_analiticas`.

## Archivos clave
- `controladorAnaliticas.ts`
- `modeloBanderaRevision.ts`
- `modeloEventoUso.ts`
- `rutasAnaliticas.ts`
- `servicioExportacionCsv.ts`
- `servicioExportacionDocx.ts`
- `servicioFirmaIntegridad.ts`
- `servicioListaAcademica.ts`
- `tiposListaAcademica.ts`
- `validacionesAnaliticas.ts`
- `validacionesEventosUso.ts`
