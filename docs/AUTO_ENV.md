...
- `EXAMEN_LAYOUT_USAR_ETIQUETA_OMR_SOLIDA` (usado en: apps/backend/src/modulos/modulo_generacion_pdf/servicioGeneracionPdf.ts)
- `EXAMEN_LAYOUT_USAR_RELLENOS_DECORATIVOS` (usado en: apps/backend/src/modulos/modulo_generacion_pdf/servicioGeneracionPdf.ts)
