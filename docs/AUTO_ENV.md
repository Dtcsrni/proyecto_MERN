...
- `OMR_ALIGN_RANGE` (usado en: apps/backend/scripts/omr-sweep-geometria.ts, apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrLegacy.ts)
...
- `OMR_AUTO_RESCUE_AMBIG_MAX` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrLegacy.ts)
- `OMR_AUTO_RESCUE_CONF_MIN` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrLegacy.ts)
- `OMR_AUTO_RESCUE_QUALITY_MIN` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrLegacy.ts)
...
- `OMR_LOCAL_SEARCH_RATIO` (usado en: apps/backend/scripts/omr-sweep-geometria.ts, apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrLegacy.ts)
...
- `OMR_OFFSET_X` (usado en: apps/backend/scripts/omr-sweep-geometria.ts, apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrLegacy.ts)
- `OMR_OFFSET_Y` (usado en: apps/backend/scripts/omr-sweep-geometria.ts, apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrLegacy.ts)
...
- `OMR_VERT_RANGE` (usado en: apps/backend/scripts/omr-sweep-geometria.ts, apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrLegacy.ts)
