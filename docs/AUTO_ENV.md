...
- `OMR_ALIGN_RANGE` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_AMBIGUITY_RATIO` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_AUTO_AMBIGUAS_MAX` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_AUTO_CONF_MIN` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_BOX_WIDTH_PTS` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_BUBBLE_RADIUS_PTS` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_CENTER_TO_LEFT_PTS` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_COLORIMETRY_ENABLED` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_COLORIMETRY_WHITE_PERCENTILE` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_DEBUG` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_DEBUG_DIR` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_DELTA_MIN` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_EXPORT_PATCHES` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_FID_RIGHT_OFFSET_PTS` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
...
- `OMR_LOCAL_DRIFT_PENALTY` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_LOCAL_SEARCH_RATIO` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_MAX_BASE64` (usado en: apps/backend/scripts/omr_calibrate.js, apps/backend/scripts/omr-validate-api.js)
- `OMR_MAX_CENTER_DRIFT_RATIO` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_MIN_CENTER_GAP` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_MIN_FILL_DELTA` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_MIN_HYBRID_CONF` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_MIN_SAFE_RANGE` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_OFFSET_X` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_OFFSET_Y` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_PATCH_DIR` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_PATCH_SIZE` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_QUALITY_REJECT_MIN` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_QUALITY_REVIEW_MIN` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_QUALITY_WARN_MIN` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_SCORE_MIN` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_SCORE_STD` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_SECOND_RATIO` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
- `OMR_STRONG_SCORE` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
...
- `OMR_VERT_RANGE` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmr.ts)
...
- `RELEASE_GATE_API_BASE` (usado en: scripts/release/gate-prod-flow.mjs)
...
- `RELEASE_GATE_DOCENTE_TOKEN` (usado en: scripts/release/gate-prod-flow.mjs)
