...
- `FEATURE_PDF_BUILDER_V2` (usado en: apps/backend/src/compartido/observabilidad/rolloutCanary.ts, apps/backend/tests/pdf.paridad.test.ts)
...
- `MONGODB_URI_HOST` (usado en: apps/backend/scripts/omr-eval-profile.ts, apps/backend/scripts/omr-sweep-geometria.ts)
...
- `OMR_AUTO_AMBIGUAS_MAX` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrV2.ts)
- `OMR_AUTO_CONF_MIN` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrV2.ts)
- `OMR_AUTO_DETECCION_MIN` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrV2.ts)
- `OMR_AUTO_RESCUE_AMBIG_MAX` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrV2.ts)
- `OMR_AUTO_RESCUE_CONF_MIN` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrV2.ts)
- `OMR_AUTO_RESCUE_QUALITY_MIN` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrV2.ts)
...
- `OMR_PROFILE_NAME` (usado en: apps/backend/scripts/omr-eval-profile.ts, apps/backend/scripts/omr-sweep-geometria.ts)
- `OMR_QUALITY_REJECT_MIN` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrV2.ts)
- `OMR_QUALITY_REVIEW_MIN` (usado en: apps/backend/src/modulos/modulo_escaneo_omr/servicioOmrV2.ts)
